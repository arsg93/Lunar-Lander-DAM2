...
window.onload = function arrancarJuego() {
    ...
    //Actualizar LA IMAGEN DE LA LUNA
    function actualizarModeloLuna() {
        if (modeloLuna == 2) {
            document.getElementById("luna").src = "img/mod2luna.png";
            document.getElementById("modeloLuna").innerHTML = "Gris";
            modeloLuna = 2;
    ...
    //Actualizar LA IMAGEN DE LA NAVE Y EL MOTOR
    function actualizarModeloNave() {
        if (modeloNave == 2) {
            document.getElementById("imgNave").src = "img/mod2nave.gif";
            document.getElementById("imgMotor").src = "img/mod2motor.gif";
            document.getElementById("modeloNave").innerHTML = "Modelo PodRacer";
...
function ocultarAjustes() {
    ...
    $.ajax({
        method: "POST",
        url: url,
        data: {"dificultad":dificultad,"modeloLuna":modeloLuna,"modeloNave":modeloNave,"intentos":intentos},
        success: function (u) {
            alert(u["mess"]);
        },
        error: function (e) {
